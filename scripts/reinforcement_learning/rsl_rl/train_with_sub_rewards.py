...
"""Script to train RL agent with RSL-RL and sub-reward logging."""
...
parser = argparse.ArgumentParser(description="Train an RL agent with RSL-RL and sub-reward logging.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    """Train with RSL-RL agent and sub-reward logging."""
